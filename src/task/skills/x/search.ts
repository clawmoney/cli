...
import { bnbotXSearch, type SearchArgs } from "./_bnbot.js";
import { searchToTwitter283, type BnbotTweet } from "./_mapper.js";
...
export const xSearchSkill: SkillHandler = {
  ...
  async run(input, ctx) {
    ...
    const wrapped = searchToTwitter283(raw as BnbotTweet[]);
    return wrapped;
  },
};
