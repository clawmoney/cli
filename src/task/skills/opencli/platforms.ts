...
const limit = (i: Record<string, unknown>, fallback?: number) => num(i, ["limit", "count"]) ?? fallback;
const query = (i: Record<string, unknown>) => reqStr(i, ["query", "keyword", "q"], "query");
const id = (i: Record<string, unknown>) => reqStr(i, ["id"], "id");
const symbol = (i: Record<string, unknown>) => reqStr(i, ["symbol", "ticker"], "symbol");
type OpenCliFlags = Record<string, string | number | boolean | undefined>;

function openSkill(
  label: string,
  base: string[],
  positional: (i: Record<string, unknown>) => string[] = () => [],
  flags: (i: Record<string, unknown>) => OpenCliFlags = () => ({}),
) {
  return makeOpenCliSkill(label, (i) => opencliCommand(base, positional(i), flags(i)));
}

export const ggSearchSkill = makeOpenCliSkill("google search", (i) =>
  bnbotCommand(["google", "search"], [query(i)], { limit: limit(i), lang: str(i, ["lang", "language"]) }),
);
export const ggSuggestSkill = makeOpenCliSkill("google suggest", (i) =>
  bnbotCommand(["google", "suggest"], [query(i)], { limit: limit(i), lang: str(i, ["lang", "language"]) }),
);
export const ggNewsSkill = makeOpenCliSkill("google news", (i) =>
  bnbotCommand(["google", "news"], str(i, ["query", "keyword", "q"]) ? [str(i, ["query", "keyword", "q"])!] : [], {
    limit: limit(i),
    lang: str(i, ["lang", "language"]),
    region: str(i, ["region", "country"]),
  }),
);
export const ggTrendsSkill = makeOpenCliSkill("google trends", (i) =>
  bnbotCommand(["google", "trends"], [], { limit: limit(i), region: str(i, ["region", "geo", "country"]) }),
);

export const wxmpArticleSearchSkill = makeOpenCliSkill("weixin article search", (i) =>
  bnbotCommand(["weixin", "search"], [query(i)], { limit: limit(i), page: num(i, ["page"]) }),
);
export const wxmpArticleSkill = makeOpenCliSkill("weixin article", (i) =>
  bnbotCommand(["weixin", "article"], [reqStr(i, ["url", "article_url", "articleUrl"], "url")]),
);

function hnList(command: string) {
  return makeOpenCliSkill(`hackernews ${command}`, (i) =>
    bnbotCommand(["hackernews", command], [], { limit: limit(i) }),
  );
}
...
export const hnSearchSkill = makeOpenCliSkill("hackernews search", (i) =>
  bnbotCommand(["hackernews", "search"], [query(i)], { limit: limit(i), sort: str(i, ["sort"]) }),
);
export const hnUserSkill = makeOpenCliSkill("hackernews user", (i) =>
  bnbotCommand(["hackernews", "user"], [reqStr(i, ["username", "user"], "username")]),
);
export const hnReadSkill = makeOpenCliSkill("hackernews read", (i) =>
  bnbotCommand(["hackernews", "read"], [reqStr(i, ["id", "item_id", "itemId"], "id")], {
    limit: limit(i),
    depth: num(i, ["depth"]),
...
export const wikiSummarySkill = makeOpenCliSkill("wikipedia summary", (i) =>
  bnbotCommand(["wikipedia", "summary"], [reqStr(i, ["title", "page"], "title")], { lang: str(i, ["lang", "language"]) }),
);
export const wikiRandomSkill = makeOpenCliSkill("wikipedia random", (i) =>
  bnbotCommand(["wikipedia", "random"], [], { lang: str(i, ["lang", "language"]) }),
);
export const wikiTrendingSkill = makeOpenCliSkill("wikipedia trending", (i) =>
  bnbotCommand(["wikipedia", "trending"], [], { limit: limit(i), lang: str(i, ["lang", "language"]) }),
);
export const wikiPageSkill = makeOpenCliSkill("wikipedia page", (i) =>
  bnbotCommand(["wikipedia", "page"], [reqStr(i, ["title", "page"], "title")], {
    lang: str(i, ["lang", "language"]),
    paragraphs: num(i, ["paragraphs"]),
  }),
);

export const yfQuoteSkill = makeOpenCliSkill("yahoo finance quote", (i) =>
  bnbotCommand(["yahoo-finance", "quote"], [reqStr(i, ["symbol", "ticker"], "symbol")]),
);

export const zhSearchSkill = makeOpenCliSkill("zhihu search", (i) =>
  bnbotCommand(["zhihu", "search"], [query(i)], { limit: limit(i) }),
);
export const zhHotSkill = makeOpenCliSkill("zhihu hot", (i) =>
  bnbotCommand(["zhihu", "hot"], [], { limit: limit(i) }),
);
export const zhRecommendSkill = makeOpenCliSkill("zhihu recommend", (i) =>
  bnbotCommand(["zhihu", "recommend"], [], { limit: limit(i) }),
);
export const zhQuestionSkill = makeOpenCliSkill("zhihu question", (i) =>
  bnbotCommand(["zhihu", "question"], [reqStr(i, ["question_id", "questionId", "id"], "question_id")], { limit: limit(i) }),
);
export const zhAnswerDetailSkill = makeOpenCliSkill("zhihu answer detail", (i) =>
  bnbotCommand(["zhihu", "answer-detail"], [reqStr(i, ["id", "answer_id", "answerId", "url"], "id")], {
    "max-content": num(i, ["maxContent", "max_content"]),
  }),
);
export const zhAnswerCommentsSkill = makeOpenCliSkill("zhihu answer comments", (i) =>
  bnbotCommand(["zhihu", "answer-comments"], [reqStr(i, ["id", "answer_id", "answerId", "url"], "id")], {
    limit: limit(i),
    "replies-limit": num(i, ["repliesLimit", "replies_limit"]),
  }),
);

export const bbcNewsSkill = makeOpenCliSkill("bbc news", (i) =>
  bnbotCommand(["bbc", "news"], [], { limit: limit(i) }),
);
export const bbcTopicSkill = makeOpenCliSkill("bbc topic", (i) =>
  bnbotCommand(["bbc", "topic"], [reqStr(i, ["topic"], "topic")], { limit: limit(i) }),
);

function bbgFeed(command: string) {
  return makeOpenCliSkill(`bloomberg ${command}`, (i) =>
    bnbotCommand(["bloomberg", command], [], { limit: limit(i) }),
  );
}
...
export const bbgFeedsSkill = makeOpenCliSkill("bloomberg feeds", () =>
  bnbotCommand(["bloomberg", "feeds"]),
);

export const medSearchSkill = makeOpenCliSkill("medium search", (i) =>
  bnbotCommand(["medium", "search"], [query(i)], { limit: limit(i) }),
);
export const medTagSkill = makeOpenCliSkill("medium tag", (i) =>
  bnbotCommand(["medium", "tag"], [reqStr(i, ["tag", "topic"], "tag")], { limit: limit(i) }),
);
...
export const subSearchSkill = makeOpenCliSkill("substack search", (i) =>
  bnbotCommand(["substack", "search"], [query(i)], {
    limit: limit(i),
    type: str(i, ["type", "kind"]),
  }),
);
export const subPublicationSkill = makeOpenCliSkill("substack publication", (i) =>
  bnbotCommand(["substack", "publication"], [reqStr(i, ["url", "publication"], "url")], { limit: limit(i) }),
);
...
export const dbTop250Skill = makeOpenCliSkill("douban top250", (i) =>
  bnbotCommand(["douban", "top250"], [], { limit: limit(i) }),
);
...
export const ctHotelSearchSkill = makeOpenCliSkill("ctrip hotel search", (i) =>
  bnbotCommand(["ctrip", "hotel-search"], [reqStr(i, ["city", "city_id", "cityId"], "city")], {
    checkin: reqStr(i, ["checkin", "check_in", "checkIn"], "checkin"),
    checkout: reqStr(i, ["checkout", "check_out", "checkOut"], "checkout"),
    limit: limit(i),
  }),
);
export const ctFlightSkill = makeOpenCliSkill("ctrip flight", (i) =>
  bnbotCommand(["ctrip", "flight"], [
